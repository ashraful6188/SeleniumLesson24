...
public class HandleFrames {
	/*
	 * Note 1: driver focus can't directly switch one frame to another frame, so
	 * at first, driver focus on homepage then it can switch to 2nd frame. 
	 * 
	...
	public static void main(String[] args) {
		...
		WebDriver driver = new ChromeDriver();// it would launch firefox browser
		// maximize the window
...
//		driver.findElement(By.xpath("//input[@name='mytext4']")).sendKeys("Finally");
		...
		// driver focus change without switchTo() method
		WebDriverWait myWait = new WebDriverWait(driver, Duration.ofSeconds(10));
		myWait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.xpath("//frame[@src='frame_4.html']")));
		driver.findElement(By.xpath("//input[@name='mytext4']")).sendKeys("Finally");
